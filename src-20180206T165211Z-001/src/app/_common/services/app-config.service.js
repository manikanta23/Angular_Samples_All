...
var AppConfigService = (function () {
    function AppConfigService(appConfig, commonDataService) {
    ...
    AppConfigService.prototype.clearLocalStorage = function () {
        var removeKeyValue = ["DefaultCustomer", "DefaultBranch", "API_URL", "App_Insights_Instrumentation_Key"];
        for (var key in removeKeyValue) {
            var localKey = removeKeyValue[key];
...
AppConfigService = __decorate([
    core_1.Injectable(),
    __param(0, core_1.Inject("api.config")),
    __metadata("design:paramtypes", [app_config_entity_1.AppConfig,
