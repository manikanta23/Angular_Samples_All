...
var NotificationService = (function () {
    ...
    NotificationService.prototype.showNotification = function (message, type) {
        var _this = this;
        var arr = [{ message: message, type: type }];
        this.show = true;
        this.type = type;
        this.message = arr;
        setTimeout(function () {
    ...
    NotificationService.prototype.showMultilineNotification = function (messageArray) {
        var _this = this;
        this.show = true;
    ...
    NotificationService.prototype.showNotificationWithoutTimeout = function (message, type) {
        var arr = [{ type: type, message: message }];
        this.show = true;
        this.isMultiline = false;
        this.type = type;
        this.message = arr;
    };
    NotificationService.prototype.hideNotification = function () {
        this.show = false;
        this.message = "";
    };
    NotificationService.prototype.errorMessage = function (componentName, componentFunctionName, serviceFunctionName, res) {
        var commonMsg = " If refreshing the page doesn't help, please submit a feedback form.";
...
(function (NotificationType) {
    ...
    NotificationType[NotificationType["Abort"] = 4] = "Abort";
    NotificationType[NotificationType["MultiLine"] = 5] = "MultiLine";
