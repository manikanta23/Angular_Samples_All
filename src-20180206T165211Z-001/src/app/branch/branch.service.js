...
var BranchService = (function () {
    function BranchService(http, commonDataService) {
        this.http = http;
        this.commonDataService = commonDataService;
    }
    BranchService.prototype.GetUserBranchesForOrdering = function (filterKey) {
        var userId = this.commonDataService.UserId;
        var take = 500;
        var url = 'api/Branches/GetUserBranchesForOrdering?query=' + filterKey + '&userId=' + userId + '&take=' + take;
